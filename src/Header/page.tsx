    ...
    <>
      ...
      <div className="fixed bottom-4 right-4">
        <div className="progress-wrap" id="scrollUp">
          <svg
            className="progress-circle w-10 h-10"
            viewBox="-1 -1 102 102"
          >
            <path
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="header-info-list hidden md:flex">
            <ul className="flex space-x-4">
              <li>
                <a href="mailto:mail@gerolddesign.com">mail@gerolddesign.com</a>
              </li>
            </ul>
          </div>
            ...
            <ul className="flex space-x-6">
              <li>
                <Popover>
                  ...
                  <Popover.Content className="sub-menu bg-white shadow-lg rounded-md p-4">
                    <ul>
                      <li>
                        <Popover>
                          <Popover.Trigger asChild>
